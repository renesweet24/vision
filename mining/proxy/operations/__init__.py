...
TASKS_TO_MINER_OPERATION_MODULES: Dict[Task, Any] = {
    ...
    Task.chat_llama_3_1_8b: chat_operation,
    Task.chat_llama_3_1_70b: chat_operation,
    Task.proteus_text_to_image: text_to_image_operation,
    Task.playground_text_to_image: text_to_image_operation,
    Task.flux_schnell_text_to_image: text_to_image_operation,
    ...
    Task.flux_schnell_image_to_image: image_to_image_operation,
    ...
    # Task.upscale: upscale_operation,
